 ...
 * @author USUARIO
 */
public class FormVerProductos extends javax.swing.JPanel implements SearchHeader2.BuscadorListener {
    ...
    public FormVerProductos() {
        ...
        String[] columnas = new String[]{
            "Codigo", "Descripcion", "Tipo", "Activo", "Opciones"
...
//        table.setEnabled(false);
        ...
        TableActionEvent event = new TableActionEvent() {
            ...
            public void onEdit(int row) {
                ...
                Producto producto = controladorProductos.obtenerProductoById(Integer.parseInt(id));
                Application.showForm(new PanelDeProducto(producto, true));
            ...
            public void onDelete(int row) {
                ...
                int respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro de que desea borrar el insumo " + producto.getDescripcion() + " ? ", "Confirmación",
...
//                throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
            ...
            public void onView(int row) {
                ...
                String id = (String) modelTable.getValueAt(row, 0);
                Producto producto = controladorProductos.obtenerProductoById(Integer.parseInt(id));
                Application.showForm(new PanelDeProducto(producto, false));
//                      throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
            }
        };
...
//        marcas.sort(Collections.reverseOrder());
        ...
        for (Producto fila : productos) {
            modelTable.addRow(new Object[]{fila.getId().toString(), fila.getDescripcion(), fila.getTipo().toString(), fila.isActivo()});
        }
...
//        marcas.sort(Collections.reverseOrder());
        ...
        for (Producto fila : productosFiltradas) {
            modelTable.addRow(new Object[]{fila.getId().toString(), fila.getDescripcion(), fila.getTipo().toString(), fila.isActivo()});
        }
